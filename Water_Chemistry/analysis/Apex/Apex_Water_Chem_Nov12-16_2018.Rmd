...
xmlfile <- xmlParse("http://192.168.1.101:80/cgi-bin/datalog.xml?sdate=181112&days=6") #*** THIS WAS THE WRONG APEX DATA
...
write.csv(Apex.Data, "~/Documents/GitHub/P_generosa/Water_Chemistry/data/Apex/Apex_data_20181112-20181116.csv", quote =FALSE, row.names = FALSE)
```

```{r}
#read in the csv file
Apex.Data <- read.csv("~/Documents/GitHub/P_generosa/Water_Chemistry/data/Apex/Apex_data_20181112-20181116.csv", stringsAsFactors = FALSE)
