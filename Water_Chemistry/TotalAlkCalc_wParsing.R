...
path<-"Data/20181102" #the location of all your titration files
massfile<-"20181102mass_run1.csv" # name of your file with masses
titrationfile<-'20181102_run1.csv'# name of the last titration file run
